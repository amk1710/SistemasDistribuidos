...
if (not isPsp()) then
  socket = require("socket") -- eu, estranhamente, tive que alterar essa linha pra fazer funcionar. Não sei exatamente o porque, talvez por causa do meu install do Lua/Love?
  require("io")
  require("ltn12")
--require("ssl")
end
